...
@Service
@Transactional
public class AgentServiceImpl extends GenericServiceImpl<Agent> implements AgentService {
    private AgentDao agentDao;

    @Autowired
    public AgentServiceImpl(@Qualifier("agentDaoImpl") GenericDao<Agent> genericDao) {
        super(genericDao);
        this.agentDao = (AgentDao) genericDao;
    }
